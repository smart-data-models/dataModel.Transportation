...
Globale Beschreibung: **Eine Beschreibung eines Verkehrsunfalls mit Ursachen und Nachwirkungen. Erste Version entwickelt im Synchronicity-Projekt**  

## Liste der Eigenschaften  

- `accidentDate`: Zeitpunkt des Unfalls  - `accidentDescription`: Beschreibung zu diesem Verkehrsunfall als Kombination der kodierten Situation aufgelistet. 0: Nicht spezifizierter Umstand; 1: Der Fahrer ist regulär gefahren, ohne zu wenden; 2: Der Fahrer ist abgelenkt oder unentschlossen gefahren; 3: Der Fahrer ist gefahren, ohne einen sicheren Abstand einzuhalten; 4: Der Fahrer ist gefahren, ohne dem von rechts kommenden Fahrzeug Vorrang zu geben; 5: Der Fahrer ist gefahren, ohne die Haltelinie zu beachten; 6: Der Fahrer ist gefahren, ohne das Signal zum Vorrang zu beachten; 7: Der Fahrer fuhr gegen den Verkehr; 8: Der Fahrer fuhr, ohne die Ampel- oder Agentensignale zu respektieren; 10: Der Fahrer fuhr, ohne die Zeichen des Durchfahrts- oder Zufahrtsverbots zu respektieren; 11: Der Fahrer fuhr mit überhöhter Geschwindigkeit; 12: Der Fahrer fuhr, ohne die Geschwindigkeitsbegrenzungen zu respektieren; 13: Der Fahrer fuhr mit den Blendlichtern, die andere Fahrzeuge kreuzen; 14: Der Fahrer ist regelmäßig nach rechts abgebogen; 15: Er ist unregelmäßig nach rechts abgebogen; 16: Der Fahrer ist regelmäßig nach links abgebogen; 17: Er ist unregelmäßig nach links abgebogen; 18: Der Fahrer ist an der Kreuzung vorbeigefahren; 20: Der Fahrer ist regelmäßig vorgefahren; 21: Der Fahrer ist abgelenkt oder unentschlossen vorgefahren; 22: Der Fahrer ist ohne Einhaltung eines Sicherheitsabstands vorgefahren; 23: Der Fahrer ist mit überhöhter Geschwindigkeit vorgefahren; 24: Fahrer fuhr ohne Beachtung der Geschwindigkeitsbegrenzungen; 25: Er fuhr nicht in der Nähe des rechten Fahrbahnrandes; 26: Fahrer fuhr gegen den Verkehr; 27: Fahrer fuhr ohne Beachtung der Durchfahrts- oder Zufahrtsverbotsschilder; 28: Fahrer fuhr mit Blendlicht, das andere Fahrzeuge kreuzt; 29: Fahrer überholte regelmäßig; 30: Er überholte unregelmäßig nach rechts; 31: Fahrer überholte in einer Kurve, auf einer Anhöhe oder bei unzureichender Sicht; 32: Er überholte ein Fahrzeug, das ein anderes überholte; 33: Fahrer überholte, ohne das entsprechende Verbotsschild zu beachten; 34: Er manövrierte im Abstieg oder in der Umkehr; 35: Fahrer manövrierte, um in den Verkehrsfluss zu gelangen; 36: Er manövrierte, um nach links abzubiegen (Privatdurchfahrt, Verteiler); 37: Fahrer manövrierte regelmäßig, um anzuhalten oder umzukehren; 38: Fahrer manövrierte unregelmäßig, um anzuhalten oder umzukehren; 39: Es gesellten sich andere unregelmäßige Zweiräder dazu; 40: Fahrer fuhr regelmäßig; 41: Fahrer fuhr mit überhöhter Geschwindigkeit; 42: Fahrer fuhr, ohne die Geschwindigkeitsbegrenzungen zu beachten; 43: Fahrer fuhr gegen den Verkehr; 44: Fahrer überholte das Fahrzeug im Gang; 45: Manövrierte; 46: Manövriert, ohne Ampel- oder Agentensignale zu respektieren; 47: Fahrer kam aus der Einfahrt, ohne Vorsicht walten zu lassen; 48: Fahrer kam von der Fahrbahn ab und stieß mit dem Fußgänger zusammen; 49: Er gab dem Fußgänger an den entsprechenden Übergängen nicht den Vorrang; 50: Er überholte ein Fahrzeug, das angehalten hatte, um den Übergang zu ermöglichen; 51: Fahrer stieß mit der Ladung gegen den Fußgänger; 52: Fahrer überholte eine Straßenbahn ungleichmäßig an der Haltestelle; 60: Der Fahrer fuhr regelmäßig; 61: Der Fahrer fuhr abgelenkt oder unentschlossen; 62: Der Fahrer fuhr, ohne einen Sicherheitsabstand einzuhalten; 63: Der Fahrer fuhr gegen den Verkehr; 64: Der Fahrer fuhr mit überhöhter Geschwindigkeit; 65: Der Fahrer fuhr, ohne die Geschwindigkeitsbegrenzungen zu beachten; 66: Der Fahrer fuhr, ohne die Zeichen des Durchfahrts- oder Zufahrtsverbots zu beachten; 67: Fahrer überholte ein anderes Fahrzeug im Gang; 68: Fahrer überquerte unvorsichtig den Bahnübergang; 70: Verschütten mit Verschütten, um Aufprall zu vermeiden; 71: List mit Verschütten wegen abgelenkten Fahrens; 72: Listen mit Verschütten bei überhöhter Geschwindigkeit; 73: Fahrer hat plötzlich gebremst mit Folge für den Transportierten; 74: Sturz einer Person aus dem Fahrzeug wegen: Türöffnung; 75: Sturz einer Person aus dem Fahrzeug wegen: Abstieg aus dem fahrenden Fahrzeug; 76: Sturz einer Person aus dem Fahrzeug wegen: Festhalten oder unsachgemäßem Aufsetzen; 80: Versagen oder Ausfall der Bremse; 81: Bruch oder Ausfall der Lenkung; 82: Reifenplatzer oder übermäßige Abnutzung; 83: Fehlen oder Mangel an Scheinwerfern oder Positionslichtern; 84: Fehlen oder Mangel an Blink- oder Bremslichtsignalen; 85: Bruch von Teilen der Anhängerkupplung; 86: Mangel an Gefahrguttransportausrüstung; 87: Mangel an den für Fahrzeuge von körperlich Behinderten vorgeschriebenen Anpassungen; 88: Ablösen von Rädern; 89: Fehlen oder Unzulänglichkeit von Sichtvorrichtungen für Fahrräder  - `accidentLocation`: Kurze Beschreibung, ob sich der Unfall in einem städtischen oder außerstädtischen Gebiet ereignet hat. 0: Regional innerhalb des Stadtgebiets 1: Stadtstraße in der Stadt 2: Provinzstraße innerhalb der Stadt 3: Staatsstraße innerhalb des Dorfes 4: Außerortsstraße 5: Provinzstraße 6: Staatsstraße 7: Autobahn 8: Anderer Weg 9: Regionalstraße  - `accidentStatisticalDate`: Ungefährer Zeitpunkt des Unfalls (oft meldet die ursprüngliche Unfalldatenquelle nur statistische Attribute wie Jahreszeit, Wochentag und ungefähre Uhrzeit  - `accidentType`: Schnelle Klassifizierung dieses Verkehrsunfalls. 1: Frontalaufprall; 2: Frontal-Seitenaufprall; 3: Seitenaufprall; 4: Kollision; 5: Fußgängeraufprall; 6: Aufprall auf ein angehaltenes oder stehendes Fahrzeug; 7: Aufprall auf ein geparktes Fahrzeug; 8: Aufprall auf ein Hindernis; 9: Aufprall auf einen Zug; 10: Auslaufen, Ausrutschen; 11: Unfall durch plötzliches Bremsen; 12: Unfall durch Sturz aus einem Fahrzeug;.  - `address`: Die Postanschrift  - `alternateName`: Ein alternativer Name für diesen Artikel  - `areaServed`: Das geografische Gebiet, in dem eine Dienstleistung oder ein angebotener Artikel erbracht wird  - `dataProvider`: Eine Folge von Zeichen, die den Anbieter der harmonisierten Dateneinheit identifiziert.  - `dateCreated`: Zeitstempel der Entitätserstellung. Dieser wird normalerweise von der Speicherplattform zugewiesen.  - `dateModified`: Zeitstempel der letzten Änderung der Entität. Dieser wird in der Regel von der Speicherplattform vergeben.  - `description`: Eine Beschreibung dieses Artikels  - `id`: Eindeutiger Bezeichner der Entität  - `localId`: Eindeutiger Bezeichner aus dem Quelldatensatz  - `location`:   - `name`: Der Name dieses Elements.  - `numPassengersDead`: Anzahl der Insassen des Fahrzeugs, die durch den Unfall ums Leben gekommen sind  - `numPassengersInjured`: Anzahl der durch den Unfall verletzten Fahrzeuginsassen  - `numPedestrianDead`: Anzahl der durch den Unfall getöteten Fußgänger  - `numPedestrianInjured`: Anzahl der durch den Unfall verletzten Fußgänger  - `owner`: Eine Liste mit einer JSON-kodierten Zeichenfolge, die auf die eindeutigen Ids der Eigentümer verweist  - `pedestriansInvolved`: Boolescher Wert, um festzustellen, ob Fußgänger an den Unfällen beteiligt waren  - `roadClass`:  Die Klassifizierung der Straße, auf der sich dieser Unfall ereignete  - `roadIntersection`: Kurze Beschreibung des Straßenstücks, auf dem sich der Unfall ereignet hat.   1: Kreuzung; 2: Kreisverkehr; 3: Gemeldete Kreuzung; 4: Kreuzung mit Ampel; 5: Kreuzung nicht gemeldet; 6: Bahnübergang; 7: Gerade; 8: Kurve; 9: Bodenwelle, Engstelle; 10: Steigung; 11: Beleuchtete Galerie; 12: Unbeleuchtete Galerie;  - `roadPaving`: Straßenbelag. 1: Gepflasterte Straße; 2: Grob gepflasterte Straße; 3: Ungepflasterte Straße;  - `roadSign`: Kurze Beschreibung des Verkehrszeichens, an dem sich der Unfall ereignet hat. 1: Abwesend; 2: Vertikal; 3: Horizontal; 4: Vertikal und horizontal; 5: Vorübergehend durch Baustelle;  - `roadSurface`: Kurze Beschreibung des Straßenzustandes zum Zeitpunkt des Unfalls. 1: Trocken; 2: Nass; 3: Glatt; 4: Gefroren; 5: Schneebedeckt;  - `roadTrunk`: Kurze Beschreibung des Typs des Straßenastes der Straße, auf der sich der Unfall ereignet hat. 1: Straßenabzweig; 2: Nebenabzweig; 3: Nebenabzweig; 4: Kreuzungsabzweig; 5: Straßenkreuzung; 6: Autobahn linker Fahrstreifen; 7: Autobahnfahrbahn rechts; 8: Autobahneinfahrt; 9: Autobahnausfahrt; 10: Autobahnknotenpunkt; 11: Autobahnstation; 12: Andere Fälle; 15: Außerortsstraße.  - `seeAlso`: Liste von uri, die auf zusätzliche Ressourcen über das Element verweist  - `source`: Eine Folge von Zeichen, die die ursprüngliche Quelle der Entitätsdaten als URL angibt. Empfohlen wird der voll qualifizierte Domänenname des Quellanbieters oder die URL zum Quellobjekt.  - `status`: Status des Verkehrsunfalls. Enum:'archived, onGoing, solved'  - `totalDeadPeopleWithin24Hours`: Anzahl der direkt durch den Unfall verstorbenen Personen  - `totalDeadPeopleWithin30Days`: Anzahl der Personen, die an den Folgen des Unfalls gestorben sind  - `totalInjured`: Gesamtzahl der durch den Unfall verletzten (nicht toten) Personen  - `type`: NGSI-Entitätstyp. es muss RoadAccident sein  - `vehiclesInvolved`: Liste der am Unfall beteiligten Fahrzeuge (und Fußgänger) 0 : Fußgänger 1 : Fahrrad 2 : landwirtschaftlichesFahrzeug 3 : Bus 4 : Kleinbus 5 : Pkw 6 : Wohnwagen 7 : Straßenbahn 8 : Tankwagen 9 : PkwMitWohnwagen 10 : PkwMitAnhänger 11 : Lastwagen 12 : Moped 13 : Tankwagen 14 : Motorrad 15 : MotorradMitAuto 16 : Motorroller 17 : Anhänger 18 : Transporter 19 : Wohnwagen 20 : Bau-oderWartungsfahrzeug 21 : Wagen 22 : Müllwagen 23 : Kehrmaschine 24 : Reinigungswagen  - `weakestSubject`: Fahrzeug, das das schwächste am Unfall beteiligte Subjekt darstellt (normalerweise Fußgänger). 0 : Fußgänger 1 : Fahrrad 2 : Landwirtschaftsfahrzeug 3 : Bus 4 : Kleinbus 5 : Pkw 6 : Wohnwagen 7 : Straßenbahn 8 : Tankwagen 9 : PkwMitWohnwagen 10 : PkwMitAnhänger 11 : Lkw 12 : Moped 13 : Tankwagen 14 : Motorrad 15 : MotorradMitWohnwagen 16 : Motorroller 17 : Anhänger 18 : Lieferwagen 19 : Wohnwagen 20 : Bau-oderWartungsfahrzeug 21 : Wagen 22 : Müllwagen 23 : Kehrmaschine 24 : Reinigungswagen  - `weatherConditions`: Kurze Beschreibung der Wetterbedingungen während dieses Verkehrsunfalls. 0 : klarNacht 1 : sonnigTag 2 : leichtbewölkt 3 : teilweisebewölkt 4 : Dunst 5 : Nebel 6 : hoheWolken 7 : bewölkt 8 : starkbewölkt 9 : bewölkt 10 : leichterRegenSchauer 11 : Nieselregen 12 : leichterRegen 13 : starkerRegenSchauer 14 : starkerRegen 15 : GraupelSchauer 16 : Graupel 17 : HagelSchauer 18 : Hagel 19 : Schauer 20 : leichterSchnee 21 : Schnee 22 : starkerSchneeSchauer 23 : starkerSchnee 24 : GewitterSchauer 25 : Gewitter    
...
Hier ist ein Beispiel für einen RoadAccident im JSON-LD-Format als Key-Values. Dies ist kompatibel mit NGSI-v2 bei Verwendung von `options=keyValues` und liefert die Kontextdaten einer einzelnen Entität.  
...
Hier ist ein Beispiel für einen RoadAccident im JSON-LD-Format wie normalisiert. Dies ist kompatibel mit NGSI-v2, wenn keine Optionen verwendet werden, und liefert die Kontextdaten einer einzelnen Entität.  
...
```  
#### RoadAccident NGSI-LD key-values Beispiel  
Hier ist ein Beispiel für einen RoadAccident im JSON-LD-Format als Key-Values. Dies ist kompatibel mit NGSI-LD bei Verwendung von `options=keyValues` und liefert die Kontextdaten einer einzelnen Entität.  
...
Hier ist ein Beispiel für einen RoadAccident im JSON-LD-Format wie normalisiert. Dies ist kompatibel mit NGSI-LD, wenn keine Optionen verwendet werden, und liefert die Kontextdaten einer einzelnen Entität.  
