...
class Type6(Enum):
    ItemFlowObserved = 'ItemFlowObserved'


class ItemFlowObserved(BaseModel):
    ...
    averageLength: Optional[confloat(ge=0.0)] = Field(
        None,
    ...
    averageSpeed: Optional[confloat(ge=0.0)] = Field(
        None,
    ...
    itemSubType: Optional[str] = Field(
        None,
    ...
    maxSpeed: Optional[confloat(ge=0.0)] = Field(
        None,
    ...
    minSpeed: Optional[confloat(ge=0.0)] = Field(
        None,
    ...
    reverseLane: Optional[bool] = Field(
        None,
    ...
    type: Optional[Type6] = Field(
        None, description='NGSI Entity type. It has to be ItemFlowObserved'
    )
