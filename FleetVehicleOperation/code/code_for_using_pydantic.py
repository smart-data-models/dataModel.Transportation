...
class InitiatingLocation(BaseModel):
...
class InitiatingLocation1(BaseModel):
    bbox: Optional[List[float]] = Field(None, min_length=4)
...
class InitiatingLocation2(BaseModel):
    bbox: Optional[List[float]] = Field(None, min_length=4)
...
class InitiatingLocation3(BaseModel):
    bbox: Optional[List[float]] = Field(None, min_length=4)
...
class InitiatingLocation4(BaseModel):
    bbox: Optional[List[float]] = Field(None, min_length=4)
    coordinates: List[List[Coordinate]]
    type: Type4
...
class InitiatingLocation5(BaseModel):
    bbox: Optional[List[float]] = Field(None, min_length=4)
...
class Type12(Enum):
    FleetVehicleOperation = 'FleetVehicleOperation'


class FleetVehicleOperation(BaseModel):
    ...
    result: Optional[str] = Field(
        None, description='The final result of the event or operation'
    )
    ...
    transportTime: Optional[float] = Field(
        None,
    ...
    type: Optional[Type12] = Field(
        None, description='NGSI Entity identifier. It has to be FleetVehicleOperation'
    )
