...
class Type6(Enum):
    RestrictionException = 'RestrictionException'


class RestrictionException(BaseModel):
    ...
    exceptionValidityHours: Optional[str] = Field(
        None, description='Days of the week and hours in which the exception is valid'
    )
    id: Optional[
        Union[
            constr(
    ...
    type: Optional[Type6] = Field(
        None, description='NGSI Entity type. It has to be RestrictionException'
    )
