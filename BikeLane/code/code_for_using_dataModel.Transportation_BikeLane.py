...
dateObserved = "{'type': 'Property', 'value': {'@type': 'DateTime', '@value': '2021-02-20T06:45:00Z'}}"
attribute = "dateObserved"
value = dateObserved
# The next line creates the query for inserting this attribute in a NGSI-LD context broker if the attribute does not exist it creates it
print(sdm.update_broker(dataModel, subject, attribute, value, serverUrl=serverUrl, updateThenCreate=True))

laneLength = {'type': 'Property', 'value': 150}
attribute = "laneLength"
value = laneLength
# The next line creates the query for inserting this attribute in a NGSI-LD context broker if the attribute does not exist it creates it
print(sdm.update_broker(dataModel, subject, attribute, value, serverUrl=serverUrl, updateThenCreate=True))

laneOccupancy = {'type': 'Property', 'value': 7}
attribute = "laneOccupancy"
value = laneOccupancy
# The next line creates the query for inserting this attribute in a NGSI-LD context broker if the attribute does not exist it creates it
print(sdm.update_broker(dataModel, subject, attribute, value, serverUrl=serverUrl, updateThenCreate=True))

laneWidth = {'type': 'Property', 'value': 2}
attribute = "laneWidth"
value = laneWidth
# The next line creates the query for inserting this attribute in a NGSI-LD context broker if the attribute does not exist it creates it
print(sdm.update_broker(dataModel, subject, attribute, value, serverUrl=serverUrl, updateThenCreate=True))
