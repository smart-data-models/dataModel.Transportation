...
class CrowdFlowObserved(BaseModel):
    ...
    averageCrowdSpeed: Optional[confloat(ge=0.0)] = Field(
        None,
    ...
    peopleCount: Optional[confloat(ge=0.0)] = Field(
        None, description='Total number of people detected during this observation'
    )
    ...
    type: Optional[Type6] = Field(
        None, description='NGSI Entity type. It has to be CrowdFlowObserved'
    )
