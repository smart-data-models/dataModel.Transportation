...
class CurrentOperative(BaseModel):
...
class LastKnownPosition1(BaseModel):
    bbox: Optional[List[float]] = Field(None, min_length=4)
...
class LastKnownPosition2(BaseModel):
    bbox: Optional[List[float]] = Field(None, min_length=4)
...
class LastKnownPosition3(BaseModel):
    bbox: Optional[List[float]] = Field(None, min_length=4)
...
class LastKnownPosition4(BaseModel):
    bbox: Optional[List[float]] = Field(None, min_length=4)
    coordinates: List[List[Coordinate]]
    type: Type4
...
class LastKnownPosition5(BaseModel):
    bbox: Optional[List[float]] = Field(None, min_length=4)
...
class Type12(Enum):
    FleetVehicleStatus = 'FleetVehicleStatus'


class FleetVehicleStatus(BaseModel):
    ...
    fleetVehicleOperation: Optional[
        Union[
            constr(
                pattern=r'^[\\w\\-\\.\\{\\}\\$\\+\\*\\[\\]`|~^@!, :\\\\]+$',
                min_length=1,
    ...
    lastKnownPositionUpdatedAt: Optional[AwareDatetime] = Field(
        None,
    ...
    restFuelAmount: Optional[float] = Field(
        None,
    ...
    type: Optional[Type12] = Field(
        None, description='NGSI Entity identifier. It has to be FleetVehicleStatus'
    )
